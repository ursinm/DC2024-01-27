...
import by.bsuir.dc.lab5.dto.MarkerRequestTo;
...
public class MarkerValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab5.controllers.MarkerController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab5.controllers.MarkerController.update(..))")

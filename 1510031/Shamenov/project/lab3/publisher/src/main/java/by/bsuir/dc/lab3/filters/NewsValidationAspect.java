...
import by.bsuir.dc.lab3.dto.NewsRequestTo;
import by.bsuir.dc.lab3.entities.News;
import by.bsuir.dc.lab3.services.interfaces.NewsService;
...
public class NewsValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab3.controllers.NewsController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab3.controllers.NewsController.update(..))")

package by.bsuir.dc.lab2.filters;

import by.bsuir.dc.lab2.dto.MarkerRequestTo;
import by.bsuir.dc.lab2.entities.Marker;
import by.bsuir.dc.lab2.services.interfaces.MarkerService;
...
public class MarkerValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab2.controllers.MarkerController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab2.controllers.MarkerController.update(..))")

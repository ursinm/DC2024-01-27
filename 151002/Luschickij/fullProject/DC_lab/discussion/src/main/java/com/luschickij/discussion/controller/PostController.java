...
import com.luschickij.discussion.utils.dtoconverter.modelassembler.PostModelAssembler;
...
public class PostController {
    ...
    public ResponseEntity<?> newEntity(@RequestBody PostRequestTo request, HttpServletRequest httpServletRequest) {
    ...
    public ResponseEntity<?> one(@PathVariable("id") Long id) {
        EntityModel<PostResponseTo> entityModel = assembler.apply(service.one(id).orElseThrow(() -> new EntityNotFoundException("Entity not found")));

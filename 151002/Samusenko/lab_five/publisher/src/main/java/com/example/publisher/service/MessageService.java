...
import com.example.publisher.kafka.KafkaMessageClient;
...
public class MessageService {
   ...
   // private final KafkaMessageClient kafkaMessageClient;
    ...
    @Cacheable(value="findById", condition = "#result != null")
    ...
    @Cacheable(value="findAll", condition = "#result != null")
    ...
    @CachePut(value = "getById", key = "#request.id")

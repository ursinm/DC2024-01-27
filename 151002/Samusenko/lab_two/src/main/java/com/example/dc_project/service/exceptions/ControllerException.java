...
public class ControllerException {
    ...
    public ResponseEntity<ErrorResponseTo> catchDuplication(DuplicateException e) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getErrorResponseTo());
    }

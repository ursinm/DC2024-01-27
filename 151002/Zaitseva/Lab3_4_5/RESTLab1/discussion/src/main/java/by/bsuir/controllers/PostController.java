...
public class PostController {
    ...
    @PostMapping
    public PostResponseTo savePost(@RequestHeader("Accept-Language") String acceptLanguageHeader, @RequestBody PostRequestTo comment) {
        return postService.savePost(comment, acceptLanguageHeader);
    }

    @PutMapping()
    public PostResponseTo updatePost(@RequestHeader("Accept-Language") String acceptLanguageHeader, @RequestBody PostRequestTo comment) {
        return postService.updatePost(comment, acceptLanguageHeader);
    }

    @GetMapping("/byIssue/{id}")
    public List<PostResponseTo> getCreatorByIssueId(@PathVariable Long id) {

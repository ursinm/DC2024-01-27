...
public class Validator{
    ...
    @Around("execution(* by.bsuir.dc.publisher.services.common.AbstractService.create(..))")
    ...
    @Around("execution(* by.bsuir.dc.publisher.services.common.AbstractService.update(..))")

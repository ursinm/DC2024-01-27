...
import com.distributed_computing.jpa.bean.DTO.CommentRequestTo;
import com.distributed_computing.jpa.bean.DTO.CommentResponseTo;
...
import com.distributed_computing.jpa.service.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<CommentResponseTo> createComment(@RequestBody @Valid CommentRequestTo commentRequestTo, BindingResult bindingResult){
        ...
        Comment comment = commentService.create(modelMapper.map(commentRequestTo, Comment.class), commentRequestTo.getTweetId());

...
{
    [ApiController]
    [Route("/api/v1.0/labels")]//Marker
    public class LabelController(IStickerService StickerService) : Controller
    {
        [HttpGet]
        ...
        [HttpPost]
        public async Task<JsonResult> CreateSticker(LabelRequestTo StickerTo)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<JsonResult> UpdateSticker(LabelRequestTo StickerTo)
        {

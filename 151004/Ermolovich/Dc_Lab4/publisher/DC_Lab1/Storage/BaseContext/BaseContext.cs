...
namespace DC_Lab1.DB.BaseDBContext
{
    public partial class BaseContext : DbContext
    {
        ...
        public virtual DbSet<StoryLabel> StoryLabels { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<StoryLabel>(entity =>
            {
                ...
                entity.Property(e => e.Id)
                    .ValueGeneratedOnAdd()
                    .HasColumnName("id");
                entity.Property(e => e.labelId).HasColumnName("stickerId");
                entity.Property(e => e.storyId).HasColumnName("storyId");

                entity.HasOne(d => d.Label).WithMany(p => p.StoryLabels).HasForeignKey(d => d.labelId);

                entity.HasOne(d => d.Story).WithMany(p => p.StoryLabels).HasForeignKey(d => d.storyId);
            });

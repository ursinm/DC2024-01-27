...
{
    public class StoryResponseTo(int Id, int? authorId, string? Title, string? Content, string? Created, string? Modified ,ICollection<Post> Posts, Author? Author) : IResponseTo
    {

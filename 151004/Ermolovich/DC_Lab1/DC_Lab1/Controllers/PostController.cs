...
{
    [ApiController]
    [Route("/api/v1.0/posts")]//Note
    public class PostController(IMessageService MessageService) : Controller
    {
        [HttpGet]
        ...
        [HttpPost]
        public async Task<JsonResult> CreateMessage(PostRequestTo MessageTo)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<JsonResult> UpdateMessage(PostRequestTo MessageTo)
        {

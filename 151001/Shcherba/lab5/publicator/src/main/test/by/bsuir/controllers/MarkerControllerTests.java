...
public class MarkerControllerTests {
    ...
    @Test
    public void testGetMarkerByTweetId() {
        ...
        long markerId = markerResponse.jsonPath().getLong("id");

        given()
                .pathParam("id", tweetId)
                .when()
                .get("/api/v1.0/markers/byTweet/{id}")
                .then()
                .statusCode(200);

...
public class NoteResponseToSerializer implements Serializer<NoteResponseTo>, Deserializer<NoteResponseTo> {
    ...
    public byte[] serialize(String topic, NoteResponseTo data) {
        try {
            System.out.println(Arrays.toString(objectMapper.writeValueAsString(data).getBytes(StandardCharsets.UTF_8)));

...
public class PostController {
    ...
    @PostMapping
    public PostResponseTo savePost(@RequestHeader(value = "Accept-Language", defaultValue = "en") String acceptLanguageHeader, @RequestBody PostRequestTo post) {
        return postService.savePost(post, acceptLanguageHeader);
    }

    @PutMapping()
    public PostResponseTo updatePost(@RequestHeader(value = "Accept-Language", defaultValue = "en") String acceptLanguageHeader, @RequestBody PostRequestTo post) {

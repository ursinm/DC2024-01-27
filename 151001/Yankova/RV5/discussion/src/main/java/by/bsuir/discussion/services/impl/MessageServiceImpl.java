...
public class MessageServiceImpl implements MessageService {
    ...
    public MessageResponseDto update(@Valid @NonNull MessageRequestDto dto) throws NoEntityExistsException {
        Optional<Message> message = dto.getId() == null || messageRepository.findMessageByNewsIdAndId(
    ...
    public Long delete(@NonNull Long id) throws NoEntityExistsException {
        ...
        if (message.isPresent()) {
            messageRepository.deleteMessageByNewsIdAndId(message.map(Message::getNewsId).orElseThrow(() ->

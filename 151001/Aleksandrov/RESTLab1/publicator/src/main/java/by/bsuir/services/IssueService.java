...
public class IssueService {
    ...
    public List<IssueResponseTo> getIssueByCriteria(List<String> labelName, List<Long> labelId, String editorLogin, String title, String content) {
        return issueListMapper.toIssueResponseList(issueDao.findIssuesByParams(labelName, labelId, editorLogin, title, content));
    }
}

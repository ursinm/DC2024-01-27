...
namespace REST.Publisher.Data.Migrations
{
    ...
    [Migration("20240402150826_MoveNoteEntityToDiscussionModule")]
    partial class MoveNoteEntityToDiscussionModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("REST.Publisher.Models.Entities.Editor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("REST.Publisher.Models.Entities.Issue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("REST.Publisher.Models.Entities.IssueTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("REST.Publisher.Models.Entities.Tag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("REST.Publisher.Models.Entities.Issue", b =>
                {
                    b.HasOne("REST.Publisher.Models.Entities.Editor", "Editor")
                        .WithMany("Issues")
            ...
            modelBuilder.Entity("REST.Publisher.Models.Entities.IssueTag", b =>
                {
                    b.HasOne("REST.Publisher.Models.Entities.Issue", "Issue")
                        .WithMany("IssueTags")
                        .HasForeignKey("IssueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("REST.Publisher.Models.Entities.Tag", "Tag")
                        .WithMany("IssueTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

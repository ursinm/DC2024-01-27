...
public class IssueService {
    ...
    public IssueResponseTo getIssueByCriteria(String stickerName, Long stickerId, String title, String content){
        return issueMapper.issueToIssueResponse(issueDao.getIssueByCriteria(stickerName, stickerId, title, content).orElseThrow(() -> new NotFoundException("Issue not found!", 40005L)));
    }

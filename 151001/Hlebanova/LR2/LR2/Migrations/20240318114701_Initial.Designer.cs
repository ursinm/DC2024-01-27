...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LR2.Models.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LR2.Models.Tag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LR2.Models.Tweet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TagTweet", b =>
                {
                    b.HasOne("LR2.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LR2.Models.Tweet", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LR2.Models.Post", b =>
                {
                    b.HasOne("LR2.Models.Tweet", "Tweet")
                        .WithMany("Posts")

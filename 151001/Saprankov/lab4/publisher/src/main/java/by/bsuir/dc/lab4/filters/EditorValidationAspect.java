...
import by.bsuir.dc.lab4.services.interfaces.EditorService;
...
public class EditorValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab4.controllers.EditorController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab4.controllers.EditorController.update(..))")

...
import by.bsuir.dc.lab4.dto.NewsRequestTo;
...
public class NewsValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab4.controllers.NewsController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab4.controllers.NewsController.update(..))")

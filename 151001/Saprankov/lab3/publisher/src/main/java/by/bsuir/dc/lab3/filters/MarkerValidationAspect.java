...
import by.bsuir.dc.lab3.dto.MarkerRequestTo;
...
public class MarkerValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab3.controllers.MarkerController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab3.controllers.MarkerController.update(..))")

...
import by.bsuir.dc.lab3.services.interfaces.EditorService;
...
public class EditorValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab3.controllers.EditorController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab3.controllers.EditorController.update(..))")

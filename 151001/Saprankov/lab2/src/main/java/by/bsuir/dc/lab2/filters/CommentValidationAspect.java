...
import by.bsuir.dc.lab2.dto.CommentRequestTo;
...
public class CommentValidationAspect {
    ...
    @Around("execution(* by.bsuir.dc.lab2.controllers.CommentController.add(..))")
    ...
    @Around("execution(* by.bsuir.dc.lab2.controllers.CommentController.update(..))")

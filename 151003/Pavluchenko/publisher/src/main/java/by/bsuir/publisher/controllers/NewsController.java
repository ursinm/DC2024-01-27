...
public class NewsController {
    ...
    @PostMapping
    public ResponseEntity<NewsResponseDto> create(@RequestBody NewsRequestDto story) throws EntityExistsException {
        return ResponseEntity.status(HttpStatus.CREATED).body(newsService.create(story));
    }
    ...
    @PutMapping
    public ResponseEntity<NewsResponseDto> update(@RequestBody NewsRequestDto story) throws NoEntityExistsException {
        return ResponseEntity.status(HttpStatus.OK).body(newsService.update(story));
    }

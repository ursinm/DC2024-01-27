...
public class MarkerController {
    ...
    @PostMapping
    public ResponseEntity<MarkerResponseDto> create(@RequestBody MarkerRequestDto label) throws EntityExistsException {
        return ResponseEntity.status(HttpStatus.CREATED).body(markerService.create(label));
    }
    ...
    @PutMapping
    public ResponseEntity<MarkerResponseDto> update(@RequestBody MarkerRequestDto label) throws NoEntityExistsException {
        return ResponseEntity.status(HttpStatus.OK).body(markerService.update(label));
    }

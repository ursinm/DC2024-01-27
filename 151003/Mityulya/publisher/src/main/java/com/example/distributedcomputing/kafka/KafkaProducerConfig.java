...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, MessageRequestTo> commentRequestToProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, MessageRequestTo> commentRequestToKafkaTemplate() {

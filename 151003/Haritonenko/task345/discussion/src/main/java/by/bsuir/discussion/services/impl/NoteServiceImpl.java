...
public class NoteServiceImpl implements NoteService {
    ...
    @Value("${topic.noteChangeTopic}")
    private String noteChangeTopic;
                ...
                try {
                    ...
                    return NoteActionDto.builder().
                            ...
                            data(ErrorDto.builder().
                                    ...
                                    note(Notes.EntityExistsException).
                                    build()).
                            build();
                }
            }
            ...
            case UPDATE -> {
                try {
                    ...
                    return NoteActionDto.builder().
                            ...
                            data(ErrorDto.builder().
                                    code(HttpStatus.BAD_REQUEST.value() + "00").
                                    note(Notes.NoEntityExistsException).
                                    build()).
                            build();
                }
            }
    ...
    public NoteResponseDto create(@Valid @NonNull NoteRequestDto dto) throws EntityExistsException {
        ...
        if (note.isEmpty()) {
            ...
            NoteActionDto noteActionDto = NoteActionDto.builder().
                    ...
                    build();
            ProducerRecord<String, NoteActionDto> record = new ProducerRecord<>(noteChangeTopic, null,
    ...
    public NoteResponseDto update(@Valid @NonNull NoteRequestDto dto) throws NoEntityExistsException {
        Optional<Note> note = dto.getId() == null || noteRepository.findNoteByStoryIdAndId(
    ...
    public Long delete(@NonNull Long id) throws NoEntityExistsException {
        ...
        noteRepository.deleteNoteByStoryIdAndId(note.map(Note::getStoryId).orElseThrow(() ->

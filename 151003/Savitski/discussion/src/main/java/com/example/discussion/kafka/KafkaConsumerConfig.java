...
import com.example.discussion.model.request.CommentRequestToSerializer;
...
public class KafkaConsumerConfig {
    @Bean
    public ConsumerFactory<String, NoteRequestTo> commentRequestToConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NoteRequestTo> commentRequestToConcurrentKafkaListenerContainerFactory() {

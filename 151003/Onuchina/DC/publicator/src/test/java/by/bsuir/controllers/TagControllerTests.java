...
public class TagControllerTests {
    ...
    public void testUpdateTag() {
        ...
        String body = "{ \"id\": " + tagId + ", \"storyId\": 8, \"name\": \"updatedname45295\" }";
    ...
    @Test
    public void testGetTagByStoryId() {
        ...
        String body = "{ \"storyId\": " + storyId + ", \"name\": \"name4845\" }";

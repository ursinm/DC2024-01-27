...
{
    public class Newservice(IMapper mapper, INewsRepository repository, IDistributedCache cache)
        : AbstractCrudService<News, NewsRequestTO, NewsResponseTO>(mapper, repository), INewservice
    {

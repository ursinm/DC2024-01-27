...
namespace Test
{
    ...
    public class PostCotrollerUnitTests
    {
        ...
        private NewsResponseTO _tweet = null!;
        ...
        public async Task TestInitialize()
        {
            ...
            var tweetLoggerMock = new Mock<ILogger<NewsController>>();
            var tweetService = new NewsService(_context, _mapper);
            var tweetController = new NewsController(tweetService, tweetLoggerMock.Object, _mapper)
            {
                ControllerContext = new ControllerContext { HttpContext = new DefaultHttpContext() }
            };
            var tweetList = (tweetController.Read().Value as List<NewsResponseTO>)!;

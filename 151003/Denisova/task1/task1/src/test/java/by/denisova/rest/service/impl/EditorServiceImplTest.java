...
class EditorServiceImplTest {
    ...
    @Mock
    private AbstractRepository<Editor, Long> editorRepository;
    ...
    class FindByIdTest {
        ...
        void testShouldThrowEntityNotFoundException() {
            ...
            final String expectedMessage = EditorServiceImpl.EDITOR_NOT_FOUND_MESSAGE.formatted(editorId);
    ...
    class UpdateTest {
        ...
        void testShouldThrowEntityNotFoundException() {
            final Editor editor = EditorTestBuilder.editor().build();
            final String expectedMessage = EditorServiceImpl.EDITOR_NOT_FOUND_MESSAGE.formatted(editor.getId());

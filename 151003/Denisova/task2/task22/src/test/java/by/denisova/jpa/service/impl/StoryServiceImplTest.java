...
class StoryServiceImplTest {
    ...
    class FindByIdTest {
        ...
        void testShouldThrowEntityNotFoundException() {
            ...
            final String expectedMessage = StoryServiceImpl.TWEET_NOT_FOUND_MESSAGE.formatted(storyId);
    ...
    class UpdateTest {
        ...
        void testShouldThrowEntityNotFoundException() {
            final Story story = StoryTestBuilder.story().build();
            final String expectedMessage = StoryServiceImpl.TWEET_NOT_FOUND_MESSAGE.formatted(story.getId());

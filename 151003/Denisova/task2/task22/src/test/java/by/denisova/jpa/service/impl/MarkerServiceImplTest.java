...
class MarkerServiceImplTest {
    ...
    class FindByIdTest {
        ...
        void testShouldThrowEntityNotFoundException() {
            ...
            final String expectedMessage = MarkerServiceImpl.TAG_NOT_FOUND_MESSAGE.formatted(markerId);
    ...
    class UpdateTest {
        ...
        void testShouldThrowEntityNotFoundException() {
            final Marker marker = MarkerTestBuilder.marker().build();
            final String expectedMessage = MarkerServiceImpl.TAG_NOT_FOUND_MESSAGE.formatted(marker.getId());
